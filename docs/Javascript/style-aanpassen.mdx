...
<HtmlCssJsEditor
  title="Style aanpassen met JavaScript"
  defaultHtml={'<h1 id="titel">Hallo!</h1>\n<p id="tekst">Dit is een paragraaf.</p>\n<p id="extra">Meer tekst hier.</p>'}
  defaultCss={'body { font-family: sans-serif; padding: 20px; }'}
  defaultJs={'document.getElementById("titel").style.color = "blue";\ndocument.getElementById("tekst").style.fontSize = "24px";\ndocument.getElementById("extra").style.backgroundColor = "lightyellow";\ndocument.getElementById("extra").style.borderRadius = "8px";'}
/>
