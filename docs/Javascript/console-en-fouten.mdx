...
<HtmlCssJsEditor
  title="Console en fouten opsporen"
  defaultHtml={'<h1 id="titel">Hallo</h1>\n<p id="bericht">Wachten...</p>'}
  defaultCss={'body { font-family: sans-serif; padding: 20px; }'}
  defaultJs={'let naam = "Jan";\nconsole.log("De naam is: " + naam);\n\ndocument.getElementById("titel").innerHTML = "Welkom, " + naam + "!";\ndocument.getElementById("bericht").innerHTML = naam + " is ingelogd.";\n\nconsole.log("Titel en bericht zijn veranderd!");'}
/>
